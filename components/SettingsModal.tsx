        ...
        <div className="fixed inset-0 z-[65] flex items-center justify-center px-4">
          ...
          >
            ...
            <div className="px-5 h-14 border-b border-[var(--material-border)] flex items-center gap-3">
              ...
              <button onClick={onClose} className="press w-8 h-8 flex items-center justify-center rounded-lg hover:bg-surface-3/60 text-text-muted hover:text-text-primary">
                <X size={14} />
              </button>
            </div>
